...
export const HOW_TO_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Give the enterprise its own name, or if left blank, the crop name is used.',
      ...
      'Interest on preharvest costs is calculated for you. Adjust the rate and months to match your operating notes.',
  ...
  },
  {
    ...
    body: [
      ...
      'Folding only changes what you can see. It does not change your numbers and is not saved with the budget.',
    ],
  },
  {
    heading: 'Where the typical values come from',
    body: [
      'Some fields have a "use typical value" link beside the label. It fills that one field, and nothing is filled in automatically.',
      'Each list states its unit at the top and its source at the bottom. Most values come from the nearest published custom rate survey. Check those against what local operators charge.',
      'If a list is quoted per bushel and the line you are filling is set to dollars per acre, the calculator will switch the line rather than putting the number in the wrong box.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'A scenario is one complete set of assumptions, saved under a name you choose. Comparing them is a primary function of this calculator.',
    ],
    steps: [
      ...
      'Duplicate it. You now have two identical budgets. (Or start a new one from scratch.)',
      ...
      'You can compare more than two budgets at once, but the first one you select is always the baseline.',
    ],
  },
  {
    heading: 'Two comparison examples',
    body: [
      'FIELD CORN AGAINST SILAGE CORN. Duplicate your corn budget. On the copy, change the yield unit to tons and enter your silage yield and price, then adjust harvest costs, considering silage chopping instead of combining and drying. Changing the unit clears any hauling or drying figure taken from the typical values, because those are published per bushel. Compare gross margin per acre. Silage revenue often looks better, and the question is whether the harvest and hauling costs absorb the difference.',
  ...
  },
  {
    ...
    body: [
      ...
      'Print produces a copy for paper or PDF.',
      ...
      'Export, on a row in the saved list, offers the same three for that budget without opening it. Use it when the budget you want files for is not the one you are working on.',
    ],
  },
]
